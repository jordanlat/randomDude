function mixingPeople() {
    ...
    let eleves = ["Madina","Mouafak","Edward","Damien","Thibau","Joël","Déborah","Anaïs","Justin","Victoria","Kévin","Allan","Antonin","Luca.R","Luca.B","Medhi","Nathan","Tom","Jordan","Florent","Eleve 1","Eleve 2","Eleve 3","Eleve 4","Cindy","Jeremy","Naïm", "Joker"];
    let check = [Madina,Mouafak,Edward,Damien,Thibau,Joël,Déborah,Anaïs,Justin,Victoria,Kévin,Allan,Antonin,LucaB,LucaR,Medhi,Nathan,Tom,Jordan,Florent,Cindy,Jeremy,Naïm,Eleve1,Eleve2,Eleve3,Eleve4,Joker];
